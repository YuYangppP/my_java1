...
public class CacheAspect {
    ...
    private static final String POINTCUT_DEPT_UPDATE="execution(* com.yu.erp.sys.service.impl.DeptServiceImpl.updateById(..))" ;
    private static final String POINTCUT_DEPT_GET="execution(* com.yu.erp.sys.service.impl.DeptServiceImpl.getById(..))" ;
    private static final String POINTCUT_DEPT_DELETE="execution(* com.yu.erp.sys.service.impl.DeptServiceImpl.removeById(..))" ;
    private static final String POINTCUT_DEPT_ADD="execution(* com.yu.erp.sys.service.impl.DeptServiceImpl.save(..))" ;
    ...
    public Object catcheDeptAdd(ProceedingJoinPoint joinPoint) throws Throwable {
        //取出第一个参数
    ...
    public Object catcheDeptGet(ProceedingJoinPoint joinPoint) throws Throwable {
        //取出第一个参数
    ...
    public Object catcheDeptUpdate(ProceedingJoinPoint joinPoint) throws Throwable {
        //取出第一个参数
    ...
    public Object catcheDeptDelete(ProceedingJoinPoint joinPoint) throws Throwable {
        //取出第一个参数
        ...
        if (isSuccess) {
            ...
            log.info("部门对象缓存已更新删除"+CACHE_DEPT_PROFIX+id);
     ...
     * 用户缓存
     */
    private static final String POINTCUT_USER_UPDATE="execution(* com.yu.erp.sys.service.impl.UserServiceImpl.updateById(..))" ;
    private static final String POINTCUT_USER_ADD="execution(* com.yu.erp.sys.service.impl.UserServiceImpl.save(..))" ;
    private static final String POINTCUT_USER_GET="execution(* com.yu.erp.sys.service.impl.UserServiceImpl.getById(..))" ;
    private static final String POINTCUT_USER_DELETE="execution(* com.yu.erp.sys.service.impl.UserServiceImpl.removeById(..))" ;
    ...
    public Object catcheUserAdd(ProceedingJoinPoint joinPoint) throws Throwable {
        //取出第一个参数
    ...
    public Object catcheUserGet(ProceedingJoinPoint joinPoint) throws Throwable {
        //取出第一个参数
        Integer object = (Integer) joinPoint.getArgs()[0];
        //从缓存里面取
        ...
        if (res1 != null) {
            ...
            log.info("未从缓存里面找到用户对象，从数据库查询"+CACHE_USER_PROFIX+res2.getId());
    ...
    public Object catcheUserUpdate(ProceedingJoinPoint joinPoint) throws Throwable {
        //取出第一个参数
    ...
    public Object catcheUserDelete(ProceedingJoinPoint joinPoint) throws Throwable {
        //取出第一个参数
        ...
        if (isSuccess) {
            ...
            log.info("用户对象缓存已更新删除"+CACHE_USER_PROFIX+id);
